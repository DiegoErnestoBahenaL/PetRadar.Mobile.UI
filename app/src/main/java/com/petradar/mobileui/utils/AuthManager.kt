...
object AuthManager {
    ...
    fun getProfilePictureUrl(context: Context): String? {
        ...
        return "${com.petradar.mobileui.api.RetrofitClient.BASE_URL}api/Users/$userId/profilepicture"
    }

    /**
     * Checks whether the user has an active session (a non-empty saved token).
     * Used in [com.petradar.mobileui.LoginActivity] to skip the login screen.
     *
