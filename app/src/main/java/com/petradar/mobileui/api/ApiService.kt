...
import com.petradar.mobileui.api.models.*
...
interface ApiService {
     ...
     * the userId is already available in [com.petradar.mobileui.utils.AuthManager].
     */
    @GET("api/UserPets")
     ...
     *
     * @param id Adoption animal ID.
     * @return List of photo filenames (pass each to [com.petradar.mobileui.utils.PetImageUrlResolver.adoptionAdditionalPhotoUrl]).
     */
    ...
    suspend fun getMatchesByUserId(@Path("userId") userId: Long): Response<List<MatchViewModel>>

    @GET("api/Matches/lost-report/{lostReportId}")
    suspend fun getMatchesByLostReportId(@Path("lostReportId") lostReportId: Long): Response<List<MatchViewModel>>

    @GET("api/Matches/stray-report/{strayReportId}")
    suspend fun getMatchesByStrayReportId(@Path("strayReportId") strayReportId: Long): Response<List<MatchViewModel>>
    ...
    /**
     * Returns the conversation between two users for a specific match.
     * Endpoint: GET /api/Messages/match/{matchId}/conversation/{recipientId}/{senderId}
     */
    @GET("api/Messages/match/{matchId}/conversation/{recipientId}/{senderId}")
...
data class MatchViewModel(
    val id: Long,
    val lostReport: ReportViewModel,
    val strayReport: ReportViewModel,
    val score: Double,
