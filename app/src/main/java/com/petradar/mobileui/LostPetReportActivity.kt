...
import com.petradar.mobileui.ui.LostPetReportScreen
import com.petradar.mobileui.ui.theme.PetRadarTheme
import com.petradar.mobileui.utils.AuthManager
import com.petradar.mobileui.viewmodel.LostPetReportViewModel
        ...
        setContent {
            PetRadarTheme {
                LostPetReportScreen(
                    ...
                    onBack = { finish() },
                    onSaved = {
                        val intent = Intent(this, MyReportsActivity::class.java).apply {
